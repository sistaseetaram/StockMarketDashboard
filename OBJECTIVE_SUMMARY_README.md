...
- **Pages (`apps/` directory)**:
  ...
  - **`prediction.py`**: A forecasting page that allows users to predict future stock prices for a selected ticker over a specified number of months (1 to 4). It utilizes the Facebook Prophet library (`fbprophet` or `prophet`) for time-series forecasting and plots the raw data and forecast using Plotly.
...
## Task Checklist
- [x] Data Acquisition (Yahoo Finance API, Stocktwit API)
- [x] EDA
- [x] Data Visualization
- [x] First web dashboard with all the insights
- [x] Machine Learning Problem Formulation
- [x] Preprocessing
- [x] Model selection and Feature Engineering
- [x] Hyperparameter tuning and Validation and finalizing the model
- [x] Prediction on test data and performance check
- [x] Prototype model deployment

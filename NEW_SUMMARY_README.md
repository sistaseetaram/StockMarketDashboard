...
- [ ] **EDA**
  1. Understanding the features and data using various statistical methods like moving average, Hypothesis tests, Computing confidence Intervals for population data etc.
- [ ] **Data Vizualization**
...
- [ ] **First web dashboard with all the insights**
  1. Base web application to show all the above results using StreamLit and deploy Heroku.
...
- [ ] **Preprocessing**
  ...
  3. Dealing with Imbalance in data.
  4. Scaling data.
...
- [ ] **Prediction on test data and performance check**
  1. Predict the results on test and real time data.
...
- [ ] **Scaling up the model by adding more features and data**
  1. Scale up the project by adding functionalities like
      1. Develop a sequence model(Deep Learning model) to achieve the same task and check its performance.
